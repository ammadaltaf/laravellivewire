        ...
        <form action="" class="my-4" wire:submit.prevent="submit">
            <div class="flex justify-around my-8">
                <div class="flex flex-wrap w-10/12">
                    <input type="text" wire:model="form.name"  class="p-2 rounded border shadow-sm w-full" placeholder="Name">
            ...
            <div class="flex justify-around my-8">
                <div class="flex flex-wrap w-10/12">
                    <input type="text" wire:model="form.password_confirmation"  class="p-2 rounded border shadow-sm w-full" placeholder="Confirm Password">
                    <span class="text-red-500 text-xs">
            ...
            <div class="flex justify-around my-8">
                <div class="flex flex-wrap w-10/12">
                    <input type="submit"  class="p-2 bg-gray-800 text-white rounded tracking-wider cursor-pointer w-full" value="Register">
                </div>
            </div>
        </form>
    </section>
